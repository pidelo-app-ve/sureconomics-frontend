...
/** @typedef {{ accessToken: string | null, refreshToken: string | null, accessExpiresAt: number | null }} StoredAuth */
 ...
 */
export const persistAuth = ({ accessToken, refreshToken, expiresIn }) => {
